const healthProfileSeed = {
  ...
  summary: {
    ...
    mechanism: "早相反应回升、峰值前移、2h 回落，提示餐后节律比基线更平稳。",
    boundary: "档案用于健康教育、趋势观察和生活方式支持，不替代医生诊断和治疗。",
  },
  bodyComposition: [
    { label: "身高", value: "160", unit: "cm", note: "源文件身体成分信息" },
    { label: "体重", value: "53.8", unit: "kg", note: "源文件身体成分信息" },
    { label: "BMI", value: "21.0", unit: "", note: "正常体重，但需关注体成分" },
    { label: "体脂率", value: "28.0", unit: "%", note: "作为长期趋势观察" },
    { label: "内脏脂肪", value: "7", unit: "级", note: "维护期重点观察" },
  ],
  keyMetrics: [
    {
      key: "ogtt_2h_glucose",
  ...
  ogtt: {
    ...
    shape: [
      "基线峰值在 2h，复查峰值前移到 1h。",
      "复查 2h 血糖回落到 6.36，3h 继续回落到 4.8。",
      "1h 血糖 8.05 属于观察信号，不单独作为糖前期判断。",
    ],
  },
  derivedIndices: [
  ...
  actionChecklist: [
    ...
    "每周 3 次抗阻训练，避免空腹高强度硬扛。",
    "重点记录餐后 3h、睡前和食物日志。",
  ],
  fixedMetricSchema: [
    "OGTT 五点葡萄糖 / 胰岛素 / C 肽",
    "HbA1c / A1 / HbF / eAG",
    "HOMA-IR / Matsuda / IGI / DI / AUC",
    "TSH / FT3 / FT4 / TT3 / TT4 / ATGAb / TPOAb",
    "TG / TC / HDL / LDL / ALT / AST / GGT",
    "GAD-Ab / IA2 / IAA / ICA",
    "身高 / 体重 / BMI / 体脂率 / 内脏脂肪 / 腰围",
  ],
};
